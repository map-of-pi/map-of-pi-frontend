...
export const ListOrder: React.FC<{
  ...
  /**
   * Unified pagination hook to handle seller's incoming orders.
   * Fetches 10 orders per page as the user scrolls.
   */
  const {
    data: orderList,
    loading,
    ...
    fetchData: (page) => fetchSellerOrders(user_id, page, 10),
    dependency: user_id,
    observerTarget,
  });
  ...
  return (
    <div>
      ...
      <div ref={observerTarget} className="h-10 w-full flex justify-center items-center mt-2">
