...
export const FileInput = (props: any) => {
  ...
  return (
    <div className="">
      ...
      <div className="flex flex-col items-center justify-center overflow-hidden py-1 rounded-md relative">
       <div className={`w-full ${props.height ? props.height : 'h-[120px]'} relative mb-1`}>
          <Image
